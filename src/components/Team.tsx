    ...
    <section className="py-24 px-6 relative overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-6xl font-black tracking-tighter mb-6 text-text-primary">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Image Container */}
              <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden mb-8 border border-card-border shadow-2xl transition-all duration-500 group-hover:border-brand-blue/50 group-hover:scale-[1.02]">
                <img
                  src={member.image}
                  alt={member.name}
              ...
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-black mb-1 text-text-primary group-hover:text-brand-blue transition-colors">
                  {member.name}
                </h3>
