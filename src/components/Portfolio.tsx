            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-lg font-bold mb-2 group-hover:text-brand-yellow transition-colors">{project.title}</h3>
                  <p className="text-white/50 text-xs mb-4 line-clamp-2">{project.desc}</p>
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-4xl bg-[#0a0a0b] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col md:flex-row h-full max-h-[80vh] md:max-h-auto"
            >
              <button 
                onClick={() => setSelectedProject(null)}
              ...
              <div className="md:w-1/2 h-64 md:h-auto relative">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0b] via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-[#0a0a0b]" />
              </div>
              ...
              <div className="md:w-1/2 p-8 md:p-12 overflow-y-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white mb-4">{t("portfolio_tech_title")}</h4>
                    <div className="flex flex-wrap gap-2">
                      {selectedProject.tech?.map((t, i) => (
                        <span key={i} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[10px] font-bold text-white/60">
                          {t}
                        </span>
                      ))}
                    </div>
                ...
                <div className="mt-12 flex gap-4">
                  <button className="flex-1 py-4 bg-white text-black rounded-2xl font-black flex items-center justify-center gap-2 hover:bg-brand-yellow transition-all">
